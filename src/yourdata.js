...
export default {
  ...
  // About Secton --------------
  aboutParaOne:
    "A mobile application developer with more than 5+ years of experience, my expertise are in native iOS and react native development. I also run a youtube channel with the name of UA Studios.",
  aboutParaTwo:
    "I have developed many applications for example E-Commerce, Event Booking App and Social Media for different clients of middle east and USA.",
  aboutParaThree:
    "In my free time I love to spend time with my family and cooking for them and love to play with my niece. ",
  aboutImage:
